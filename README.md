...
Le modèle ici doit prédire une target binaire pour chaque image. La prédiction est proche de 0 lorsque la lésion est bénigne et proche de 1 lorsqu’elle indique une lésion maligne.
      ...
      Installation et librairie requise
...
- Predict
      ...
      Methode speciale: 
- Geffnet : Librairie permettant d'importer le modèle Effnet-B7 avec une taille d'entrée (résolution d'image de 640) ou encore Enetv2.
Ces modèles sont une famille de modèles de classification d'images, qui atteignent une précision de pointe.
- Librairie albumentation : Permet de palier aux problèmes du nombre de données par data augmentation
